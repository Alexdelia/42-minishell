...
SRCS = utils/prompt_utils.c engine/ft_word_split.c engine/ft_exec_call.c \
		...
		utils/ft_error.c utils/ft_statable.c utils/ft_len_post_transform.c utils/ft_transform_utils.c utils/exec_call_utils.c utils/exec_call_utils2.c engine/ft_fd.c
